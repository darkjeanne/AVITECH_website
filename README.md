...
2. **Step 1**: Upload **your photo (1:1 ratio)** in **PNG format** to the directory **"profiles/YourName/"**:
...
3. **Step 2**: Edit the files **“YourName_vn.html”** and **“YourName_en.html”** in the directory **"profiles/YourName/"**:
